...
function sortByDuration(data, flightLength){
  const orderedPodcasts = flightLength <= 60 ? data.sort((a,b)=> a.duration - b.duration) : data.sort((a,b)=> b.duration - a.duration)
  
    for (let i = 0; i<orderedPodcasts.length; i++) {
        console.log(`${i+1}. ${orderedPodcasts[i].title}, ${orderedPodcasts[i].duration} minutes`)
    }
